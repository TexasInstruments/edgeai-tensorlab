...
# -- Project information -----------------------------------------------------
# ModelZoo Artifacts documentation build configuration file
...
copyright = '&copy; Copyright 2018-' + str(datetime.date.today().year)
...
with open('docs/modelartifacts.rst', 'w') as fp:
    ...
    for line in artifacts_list:
        words = line.split(',')
        download_name = os.path.join(words[2]+'.tar.gz')
        download_file = os.path.join(artifacts_location, download_name)
        fp.write(f'\n    {words[0]}, {words[1]}, {download_file}, {words[3]}')
    #
    fp.write(f'\n')
