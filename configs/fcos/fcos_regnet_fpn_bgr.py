_base_ = [
    ...
    '../_jacinto_ai_base_/hyper_params/fcos_config.py',
...
regnet_settings = {
    'regnetx_800mf':{'regnet_base_channels':32, 'bacbone_out_channels':[64, 128, 288, 672], 'group_size_dw':16,
                     'fpn_out_channels':min(64*decoder_width_fact,256), 'fcos_stacked_convs':3, 'fpn_num_blocks':3,
    ...
    'regnetx_1.6gf':{'regnet_base_channels':32, 'bacbone_out_channels':[72, 168, 408, 912], 'group_size_dw':24,
                     'fpn_out_channels':min(96*decoder_width_fact,256), 'fcos_stacked_convs':4, 'fpn_num_blocks':4,
