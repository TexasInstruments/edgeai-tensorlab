...
model = dict(
    ...
    backbone=dict(type='CSPDarknet', deepen_factor=0.33, widen_factor=0.125,act_cfg=dict(type='ReLU')),
    neck=dict(
        type='YOLOXPAFPN',
    ...
    bbox_head=dict(
        type='YOLOXHead', num_classes=num_classes, in_channels=32, feat_channels=32,act_cfg=dict(type='ReLU')),
