...
model = dict(
    ...
    backbone=dict(deepen_factor=0.33, widen_factor=0.1875),
    neck=dict(in_channels=[48,96,192], out_channels=48, num_csp_blocks=1),
    bbox_head=dict(in_channels=48, feat_channels=48))
