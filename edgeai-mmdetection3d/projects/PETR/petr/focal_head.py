...
class FocalHead(AnchorFreeHead):
    ...
    def __init__(self,
                 ...
                 loss_cls = dict( #  Just to pass it to AnchorFreeHead, Not used.
    ...
    def loss_by_feat(self,
        ...
        enc_loss_cls, enc_losses_bbox, enc_losses_iou, centers2d_losses, centerness_losses = \
            self.loss_by_feat_single(enc_cls_scores, enc_bbox_preds, pred_centers2d, centerness,
    ...
    def loss_by_feat_single(self,
        ...
        num_total_pos = torch.clamp(reduce_mean(num_total_pos), min=1).item()
         ...
         #centerness BCE loss
        img_shape = [img_metas[0]['pad_shape']] * num_imgs
    ...
    def get_targets(self,
        ...
        img_meta = {'pad_shape':img_metas[0]['pad_shape']}
    ...
    def _get_target_single(self,
        ...
        pred_instance = InstanceData(priors=bbox_pred)
        gt_instances = InstanceData(bboxes_3d=gt_bboxes)
        sampling_result = self.sampler.sample(assign_result, pred_instance, gt_instances)
