...
from .bevformer_spatial_cross_attention import MSDeformableAttention3D
from .bevformer_decoder import CustomMSDeformableAttention
...
class PerceptionTransformer(BaseModule):
    ...
    def get_bev_features(
        ...
        bev_queries = bev_queries.unsqueeze(1).repeat(1, bs, 1) # [2500, 1, 256]
        ...
        bev_embed = self.encoder(
            bev_queries,
            feat_flatten, # feat + param embed
            feat_flatten, # feat + param embd
            bev_h=bev_h,
            bev_w=bev_w,
            bev_pos=bev_pos,
    ...
    def forward(self,
        ...
        reference_points = self.reference_points(query_pos) # linear transform
