...
def normalize_bbox_type1(bboxes, pc_range):
...
def denormalize_bbox_type1(normalized_bboxes, pc_range):
    # rotation
...
# For StreamPETR and Far3D
def denormalize_bbox_type2(normalized_bboxes, pc_range):
    # rotation 
    rot_sine = normalized_bboxes[..., 6:7]
    rot_cosine = normalized_bboxes[..., 7:8]
    rot = torch.atan2(rot_sine, rot_cosine)
