...
from tools.dataset_converters import nuscenes_converter_bevformer as nuscenes_converter_bevformer
...
def nuscenes_data_prep(root_path,
    ...
    """
    nuscenes_converter_bevformer.create_nuscenes_infos(
        root_path, out_dir, can_bus_root_path, info_prefix, version=version, max_sweeps=max_sweeps)

    if version == 'v1.0-test':
        info_test_path = osp.join(
            out_dir, f'{info_prefix}_infos_temporal_test.pkl')
        nuscenes_converter_bevformer.export_2d_annotation(
            root_path, info_test_path, version=version)
    else:
        #info_train_path = osp.join(
        #    out_dir, f'{info_prefix}_infos_temporal_latest_train.pkl')
        info_val_path = osp.join(
            out_dir, f'{info_prefix}_infos_temporal_latest_val.pkl')
        #nuscenes_converter_bevformer.export_2d_annotation(
