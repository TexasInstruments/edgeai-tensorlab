...
class DeepLabV3Plus(_SimpleSegmentationModel):
    ...
    def __init__(self, backbone, classifier, aux_classifier=None):
        super(DeepLabV3Plus, self).__init__(backbone, classifier, aux_classifier, dict_features=True)


class DeepLabV3PlusHead(nn.Module):
    def __init__(self, in_channels, num_classes, shortcut_channels, refine_decoder=True, **kwargs):
