...
# python run_image_classification_quantization.py --train_dir /home/a0491009/datasets/imagenet2012/data/train --validation_dir /home/a0491009/datasets/imagenet2012/data/val --output_dir ./imagenet --remove_unused_columns False --do_train --do_eval --per_device_train_batch_size 1 --per_device_eval_batch_size 1 --max_steps 100 --overwrite_output_dir --model_name_or_path microsoft/swin-tiny-patch4-window7-224 --max_eval_samples 1000 --use_cpu --label_names labels