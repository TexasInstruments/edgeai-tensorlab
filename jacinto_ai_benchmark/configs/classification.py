...
def get_configs(settings, work_dir):
    ...
    pipeline_configs = {
        ...
        'vclsimg-11-00':utils.dict_update(common_cfg,
        ...
        'vclsimg-11-01':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_onnx(),
            session=sessions.TVMDLRSession(**common_session_cfg, **settings.session_tvm_dlr_cfg,
        ...
        'vclsimg-11-01q8':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_onnx(),
        ...
        'vclsimg-12-01':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_onnx(),
            session=sessions.TVMDLRSession(**common_session_cfg, **settings.session_tvm_dlr_cfg,
        ...
        'vclsimg-12-02':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_onnx(),
            session=sessions.TVMDLRSession(**common_session_cfg, **settings.session_tvm_dlr_cfg,
        ...
        'vclsimg-12-02q8':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_onnx(),
            session=sessions.TVMDLRSession(**common_session_cfg, **settings.session_tvm_dlr_cfg_qat,
        ...
        'vclsimg-12-04':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_onnx(),
            session=sessions.TVMDLRSession(**common_session_cfg, **settings.session_tvm_dlr_cfg,
        ...
        'vclsimg-12-05':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_onnx(),
            session=sessions.TVMDLRSession(**common_session_cfg, **settings.session_tvm_dlr_cfg,
        ...
        'vclsimg-12-06':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_onnx(),
            session=sessions.TVMDLRSession(**common_session_cfg, **settings.session_tvm_dlr_cfg,
        ...
        'vclsimg-12-07':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_onnx(),
            session=sessions.TVMDLRSession(**common_session_cfg, **settings.session_tvm_dlr_cfg,
        ...
        'vclsimg-13-00':utils.dict_update(common_cfg,
        ...
        'vclsimg-13-01':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_onnx(reverse_channels=True),
            session=sessions.TVMDLRSession(**common_session_cfg, **settings.session_tvm_dlr_cfg,
        ...
        'vclsimg-13-02':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_onnx(reverse_channels=True),
            session=sessions.TVMDLRSession(**common_session_cfg, **settings.session_tvm_dlr_cfg,
        ...
        'vclsimg-13-04':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_onnx(reverse_channels=True),
            session=sessions.TVMDLRSession(**common_session_cfg, **settings.session_tvm_dlr_cfg,
        ...
        'vclsimg-10-00':utils.dict_update(common_cfg,
        ...
        'vclsimg-10-01':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_tflite(),
            session=sessions.TFLiteRTSession(**common_session_cfg, **settings.session_tflite_rt_cfg,
        ...
        'vclsimg-10-02':utils.dict_update(common_cfg,
        ...
        'vclsimg-14-00':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_tflite(),
            session=sessions.TFLiteRTSession(**common_session_cfg, **settings.session_tflite_rt_cfg,
        ...
        'vclsimg-14-00q8':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_tflite(),
            session=sessions.TFLiteRTSession(**common_session_cfg, **settings.session_tflite_rt_cfg,
        ...
        'vclsimg-14-01':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_tflite(),
            session=sessions.TFLiteRTSession(**common_session_cfg, **settings.session_tflite_rt_cfg,
        ...
        'vclsimg-14-01q8':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_tflite(),
            session=sessions.TFLiteRTSession(**common_session_cfg, **settings.session_tflite_rt_cfg,
        ...
        'vclsimg-14-02':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_tflite(),
            session=sessions.TFLiteRTSession(**common_session_cfg, **settings.session_tflite_rt_cfg,
        ...
        'vclsimg-14-03':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_tflite(),
            session=sessions.TFLiteRTSession(**common_session_cfg, **settings.session_tflite_rt_cfg,
        ...
        'vclsimg-14-04':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_tflite(),
            session=sessions.TFLiteRTSession(**common_session_cfg, **settings.session_tflite_rt_cfg,
        ...
        'vclsimg-14-05q8':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_tflite(),
            session=sessions.TFLiteRTSession(**common_session_cfg, **settings.session_tflite_rt_cfg,
        ...
        'vclsimg-14-06':utils.dict_update(common_cfg,
        ...
        'vclsimg-14-07':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_tflite(),
            session=sessions.TFLiteRTSession(**common_session_cfg, **settings.session_tflite_rt_cfg,
        ...
        'vclsimg-14-08':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_tflite(),
            session=sessions.TFLiteRTSession(**common_session_cfg, **settings.session_tflite_rt_cfg,
        ...
        'vclsimg-14-09':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_tflite(mean=(123.675, 116.28, 103.53), scale=(1.0, 1.0, 1.0)),
            session=sessions.TFLiteRTSession(**common_session_cfg, **settings.session_tflite_rt_cfg,
        ...
        'vclsimg-14-0a':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_tflite(),
            session=sessions.TFLiteRTSession(**common_session_cfg, **settings.session_tflite_rt_cfg,
        ...
        'vclsimg-15-00':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_tflite(),
            session=sessions.TFLiteRTSession(**common_session_cfg, **settings.session_tflite_rt_cfg,
        ...
        'vclsimg-15-01':utils.dict_update(common_cfg,
        ...
        'vclsimg-15-02':utils.dict_update(common_cfg,
        ...
        'vclsimg-15-04':utils.dict_update(common_cfg,
        ...
        'vclsimg-15-10':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_tflite(),
            session=sessions.TFLiteRTSession(**common_session_cfg, **settings.session_tflite_rt_cfg,
        ...
        'vclsimg-15-11':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_tflite(274, 240),
            session=sessions.TFLiteRTSession(**common_session_cfg, **settings.session_tflite_rt_cfg,
        ...
        'vclsimg-15-12':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_tflite(343, 300),
            session=sessions.TFLiteRTSession(**common_session_cfg, **settings.session_tflite_rt_cfg,
        ...
        'vclsimg-16-10':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_tflite(342, 299),
            session=sessions.TFLiteRTSession(**common_session_cfg, **settings.session_tflite_rt_cfg,
