...
def get_configs(settings, work_dir):
    ...
    pipeline_configs = {
        ...
        'vclsimg-10-01q8':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_onnx(),
        ...
        'vclsimg-30-01':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_onnx(),
            session=sessions.TVMDLRSession(**common_session_cfg, **settings.session_tvm_dlr_cfg,
        ...
        'vclsimg-30-02':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_onnx(),
            session=sessions.TVMDLRSession(**common_session_cfg, **settings.session_tvm_dlr_cfg,
        ...
        'vclsimg-30-02q8':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_onnx(),
            session=sessions.TVMDLRSession(**common_session_cfg, **settings.session_tvm_dlr_cfg_qat,
        ...
        'vclsimg-30-04':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_onnx(),
            session=sessions.TVMDLRSession(**common_session_cfg, **settings.session_tvm_dlr_cfg,
        ...
        'vclsimg-30-05':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_onnx(),
            session=sessions.TVMDLRSession(**common_session_cfg, **settings.session_tvm_dlr_cfg,
        ...
        'vclsimg-30-06':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_onnx(),
            session=sessions.TVMDLRSession(**common_session_cfg, **settings.session_tvm_dlr_cfg,
        ...
        'vclsimg-31-00':utils.dict_update(common_cfg,
        ...
        'vclsimg-31-01':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_onnx(reverse_channels=True),
            session=sessions.TVMDLRSession(**common_session_cfg, **settings.session_tvm_dlr_cfg,
        ...
        'vclsimg-31-02':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_onnx(reverse_channels=True),
            session=sessions.TVMDLRSession(**common_session_cfg, **settings.session_tvm_dlr_cfg,
        ...
        'vclsimg-31-04':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_onnx(reverse_channels=True),
            session=sessions.TVMDLRSession(**common_session_cfg, **settings.session_tvm_dlr_cfg,
        ...
        'vclsimg-32-00':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_onnx(),
            session=sessions.TVMDLRSession(**common_session_cfg, **settings.session_tvm_dlr_cfg,
        ...
        'vclsimg-20-00':utils.dict_update(common_cfg,
        ...
        'vclsimg-20-01':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_tflite(),
            session=sessions.TFLiteRTSession(**common_session_cfg, **settings.session_tflite_rt_cfg,
        ...
        'vclsimg-20-02':utils.dict_update(common_cfg,
        ...
        'vclsimg-40-00q8':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_tflite(),
            session=sessions.TFLiteRTSession(**common_session_cfg, **settings.session_tflite_rt_cfg,
        ...
        'vclsimg-40-01':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_tflite(),
            session=sessions.TFLiteRTSession(**common_session_cfg, **settings.session_tflite_rt_cfg,
        ...
        'vclsimg-40-01q8':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_tflite(),
            session=sessions.TFLiteRTSession(**common_session_cfg, **settings.session_tflite_rt_cfg,
        ...
        'vclsimg-40-02':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_tflite(),
            session=sessions.TFLiteRTSession(**common_session_cfg, **settings.session_tflite_rt_cfg,
        ...
        'vclsimg-40-03':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_tflite(),
            session=sessions.TFLiteRTSession(**common_session_cfg, **settings.session_tflite_rt_cfg,
        ...
        'vclsimg-40-04':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_tflite(),
            session=sessions.TFLiteRTSession(**common_session_cfg, **settings.session_tflite_rt_cfg,
        ...
        'vclsimg-40-05q8':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_tflite(),
            session=sessions.TFLiteRTSession(**common_session_cfg, **settings.session_tflite_rt_cfg,
        ...
        'vclsimg-40-06':utils.dict_update(common_cfg,
        ...
        'vclsimg-40-07':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_tflite(),
            session=sessions.TFLiteRTSession(**common_session_cfg, **settings.session_tflite_rt_cfg,
        ...
        'vclsimg-40-08':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_tflite(),
            session=sessions.TFLiteRTSession(**common_session_cfg, **settings.session_tflite_rt_cfg,
        ...
        'vclsimg-40-09':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_tflite(mean=(123.675, 116.28, 103.53), scale=(1.0, 1.0, 1.0)),
            session=sessions.TFLiteRTSession(**common_session_cfg, **settings.session_tflite_rt_cfg,
        ...
        'vclsimg-40-0a':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_tflite(),
            session=sessions.TFLiteRTSession(**common_session_cfg, **settings.session_tflite_rt_cfg,
        ...
        'vclsimg-41-00':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_tflite(),
            session=sessions.TFLiteRTSession(**common_session_cfg, **settings.session_tflite_rt_cfg,
        ...
        'vclsimg-41-01':utils.dict_update(common_cfg,
        ...
        'vclsimg-41-02':utils.dict_update(common_cfg,
        ...
        'vclsimg-41-04':utils.dict_update(common_cfg,
        ...
        'vclsimg-41-10':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_tflite(),
            session=sessions.TFLiteRTSession(**common_session_cfg, **settings.session_tflite_rt_cfg,
        ...
        'vclsimg-41-11':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_tflite(274, 240),
            session=sessions.TFLiteRTSession(**common_session_cfg, **settings.session_tflite_rt_cfg,
        ...
        'vclsimg-41-12':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_tflite(343, 300),
            session=sessions.TFLiteRTSession(**common_session_cfg, **settings.session_tflite_rt_cfg,
