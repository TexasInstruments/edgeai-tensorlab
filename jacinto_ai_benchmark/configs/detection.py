...
def get_configs(settings, work_dir):
    ...
    pipeline_configs = {
        ...
        # 'vdetcoco-10-10':utils.dict_update(common_cfg,
        ...
        # 'vdetcoco-17-00':utils.dict_update(common_cfg,
        ...
        'vdetcoco-14-20':utils.dict_update(common_cfg,
        ...
        'vdetcoco-14-21':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_tflite((300,300), (300,300), backend='cv2'),
            session=sessions.TFLiteRTSession(**common_session_cfg, **settings.session_tflite_rt_cfg,
        ...
        'vdetcoco-14-22':utils.dict_update(common_cfg,
        ...
        'vdetcoco-14-23':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_tflite((320,320), (320,320), backend='cv2'),
            session=sessions.TFLiteRTSession(**common_session_cfg, **settings.session_tflite_rt_cfg,
        ...
        'vdetcoco-14-24':utils.dict_update(common_cfg,
            preprocess=settings.get_preproc_tflite((300,300), (300,300), backend='cv2'),
            session=sessions.TFLiteRTSession(**common_session_cfg, **settings.session_tflite_rt_cfg,
        ...
        # 'vdetcoco-14-25':utils.dict_update(common_cfg,
        ...
        # 'vdetcoco-16-20':utils.dict_update(common_cfg,
        #     preprocess=settings.get_preproc_tflite((640,640), (640,640), backend='cv2'),
        #     session=sessions.TFLiteRTSession(**common_session_cfg, **settings.session_tflite_rt_cfg,
        ...
        # 'vdetcoco-16-21':utils.dict_update(common_cfg,
        #     preprocess=settings.get_preproc_tflite((640,640), (640,640), backend='cv2'),
        #     session=sessions.TFLiteRTSession(**common_session_cfg, **settings.session_tflite_rt_cfg,
        ...
        # 'vdetcoco-16-22':utils.dict_update(common_cfg,
        ...
        # 'vdetcoco-17-20':utils.dict_update(common_cfg,
