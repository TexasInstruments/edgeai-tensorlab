...
def get_configs(settings, work_dir):
    ...
    pipeline_configs = {
        ...
        'vsegcity-10-30':utils.dict_update(cityscapes_cfg,
        ...
        'vsegcity-10-31':utils.dict_update(cityscapes_cfg,
            preprocess=settings.get_preproc_jai((384,768), (384,768), backend='cv2', interpolation=cv2.INTER_AREA),
            session=sessions.TVMDLRSession(**common_session_cfg, **settings.session_tvm_dlr_cfg,
        ...
        'vsegcity-10-32':utils.dict_update(cityscapes_cfg,
            preprocess=settings.get_preproc_jai((384,768), (384,768), backend='cv2', interpolation=cv2.INTER_AREA),
            session=sessions.TVMDLRSession(**common_session_cfg, **settings.session_tvm_dlr_cfg,
        ...
        'vsegcity-10-33':utils.dict_update(cityscapes_cfg,
            preprocess=settings.get_preproc_jai((384,768), (384,768), backend='cv2', interpolation=cv2.INTER_AREA),
            session=sessions.TVMDLRSession(**common_session_cfg, **settings.session_tvm_dlr_cfg,
        ...
        'vsegcity-10-34':utils.dict_update(cityscapes_cfg,
        ...
        'vsegcity-10-35':utils.dict_update(cityscapes_cfg,
        ...
        'vsegcity-30-30':utils.dict_update(cityscapes_cfg,
        ...
        'vsegcity-30-31':utils.dict_update(cityscapes_cfg,
            preprocess=settings.get_preproc_onnx((520,1040), (520,1040), backend='cv2'),
            session=sessions.TVMDLRSession(**common_session_cfg, **settings.session_tvm_dlr_cfg,
