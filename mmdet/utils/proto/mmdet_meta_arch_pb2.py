...
# source: detection_meta_arch.proto
...
TIDLMetaArch = _reflection.GeneratedProtocolMessageType('TIDLMetaArch', (_message.Message,), dict(
  ...
  __module__ = 'detection_meta_arch_pb2'
