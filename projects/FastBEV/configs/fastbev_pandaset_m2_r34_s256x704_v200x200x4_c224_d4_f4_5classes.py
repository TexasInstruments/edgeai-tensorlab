# -*- coding: utf-8 -*-
_base_ = [
    'mmdet3d::_base_/datasets/pandaset-3d-5classes.py',
...
model = dict(
    ...
    test_cfg=dict(
        ...
        nms_thr_list=[0.2, 0.2, 0.5, 0.5, 0.2],
        nms_radius_thr_list=[4, 10, 2.0, 0.175, 1.0],
        nms_rescale_factor=[1.0, 0.4, 2.0, 9.0, 1.0],
    )
)
...
class_names = [
    'Car','Bus','Bicycle','Pedestrian','Temporary Construction Barriers'
]
