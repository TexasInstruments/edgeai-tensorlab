...
from mmengine.model.base_module import Sequential, BaseModule
...
class Sparse4DeformableFeatureAggregation(BaseModule):
    def __init__(
        self,
        embed_dims: int = 256,
        num_groups: int = 8,
        ...
        super(Sparse4DeformableFeatureAggregation, self).__init__()
    ...
    def feature_sampling(
        ...
        points_2d = Sparse4DeformableFeatureAggregation.project_points(
