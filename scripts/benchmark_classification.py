...
pipeline_configs = [
    ...
    utils.dict_update(pipeline_cfg, {
        'preprocess':settings.get_preproc_tvm_dlr(reverse_channels=True),
        'session':sessions.TVMDLRSession(**settings.session_tvm_dlr_cfg, work_dir=work_dir,
    ...
    utils.dict_update(pipeline_cfg, {
        'preprocess':settings.get_preproc_tflite_rt(297, 260),
        'session':sessions.TFLiteRTSession(**settings.session_tflite_rt_cfg, work_dir=work_dir,
    ...
    utils.dict_update(pipeline_cfg, {
        'preprocess':settings.get_preproc_tflite_rt(343, 300),
        'session':sessions.TFLiteRTSession(**settings.session_tflite_rt_cfg, work_dir=work_dir,
    ...
    utils.dict_update(pipeline_cfg, {
        'preprocess':settings.get_preproc_tflite_rt(274, 240),
        'session':sessions.TFLiteRTSession(**settings.session_tflite_rt_cfg, work_dir=work_dir,
