...
pipeline_configs = [
    ...
    utils.dict_update(common_cfg, {
        ...
        'session':sessions.TVMDLRSession(**common_session_cfg, **config.session_tvm_dlr_cfg,
            model_path=f'{config.modelzoo_path}/vision/cls/imagenet1k/jai-pytorch/mobilenet_v1_20190906-171544_opset9.onnx')
    }),
    # jai-devkit: classification mobilenetv2_224x224 expected_metric: 72.13% top-1 accuracy
    utils.dict_update(common_cfg, {
        'preprocess':config.get_preproc_onnx(),
        'session':sessions.TVMDLRSession(**common_session_cfg, **config.session_tvm_dlr_cfg,
            model_path=f'{config.modelzoo_path}/vision/cls/imagenet1k/jai-pytorch/mobilenet_v2_20191224-153212_opset9.onnx')
    }),
    ...
    utils.dict_update(common_cfg, {
        ...
        'session':sessions.TVMDLRSession(**common_session_cfg, **config.session_tvm_dlr_cfg_qat,
            model_path=f'{config.modelzoo_path}/vision/cls/imagenet1k/jai-pytorch/mobilenet_v2_qat-jai_20201213-165307_opset9.onnx')
    }),
    ...
    utils.dict_update(common_cfg, {
        ...
        'session':sessions.TVMDLRSession(**common_session_cfg, **config.session_tvm_dlr_cfg,
            model_path=f'{config.modelzoo_path}/vision/cls/imagenet1k/pycls/RegNetX-200MF_dds_8gpu_opset9.onnx')
    }),
    # pycls: classification regnetx400mf_224x224 expected_metric: 72.7% top-1 accuracy
    utils.dict_update(common_cfg, {
        'preprocess':config.get_preproc_onnx(reverse_channels=True),
        'session':sessions.TVMDLRSession(**common_session_cfg, **config.session_tvm_dlr_cfg,
            model_path=f'{config.modelzoo_path}/vision/cls/imagenet1k/pycls/RegNetX-400MF_dds_8gpu_opset9.onnx')
    }),
    # pycls: classification regnetx800mf_224x224 expected_metric: 75.2% top-1 accuracy
    utils.dict_update(common_cfg, {
        'preprocess':config.get_preproc_onnx(reverse_channels=True),
        'session':sessions.TVMDLRSession(**common_session_cfg, **config.session_tvm_dlr_cfg,
            model_path=f'{config.modelzoo_path}/vision/cls/imagenet1k/pycls/RegNetX-800MF_dds_8gpu_opset9.onnx')
    }),
    # pycls: classification regnetx1.6gf_224x224 expected_metric: 77.0% top-1 accuracy
    utils.dict_update(common_cfg, {
        'preprocess':config.get_preproc_onnx(reverse_channels=True),
        'session':sessions.TVMDLRSession(**common_session_cfg, **config.session_tvm_dlr_cfg,
            model_path=f'{config.modelzoo_path}/vision/cls/imagenet1k/pycls/RegNetX-1.6GF_dds_8gpu_opset9.onnx')
    }),
    #################torchvision models#########################
    ...
    utils.dict_update(common_cfg, {
        'preprocess':config.get_preproc_onnx(),
        'session':sessions.TVMDLRSession(**common_session_cfg, **config.session_tvm_dlr_cfg,
            model_path=f'{config.modelzoo_path}/vision/cls/imagenet1k/torchvision/shufflenet_v2_x1.0_opset9.onnx')
    }),
    # torchvision: classification mobilenetv2_224x224 expected_metric: 71.88% top-1 accuracy
    utils.dict_update(common_cfg, {
        'preprocess':config.get_preproc_onnx(),
        'session':sessions.TVMDLRSession(**common_session_cfg, **config.session_tvm_dlr_cfg,
            model_path=f'{config.modelzoo_path}/vision/cls/imagenet1k/torchvision/mobilenet_v2_tv_opset9.onnx')
    }),
    # torchvision: classification mobilenetv2_224x224 expected_metric: 71.88% top-1 accuracy, QAT: 71.31%
    utils.dict_update(common_cfg, {
        'preprocess':config.get_preproc_onnx(),
        'session':sessions.TVMDLRSession(**common_session_cfg, **config.session_tvm_dlr_cfg_qat,
            model_path=f'{config.modelzoo_path}/vision/cls/imagenet1k/torchvision/mobilenet_v2_tv_qat-jai_opset9.onnx')
    }),
    # torchvision: classification resnet18_224x224 expected_metric: 69.76% top-1 accuracy
    utils.dict_update(common_cfg, {
        'preprocess':config.get_preproc_onnx(),
        'session':sessions.TVMDLRSession(**common_session_cfg, **config.session_tvm_dlr_cfg,
            model_path=f'{config.modelzoo_path}/vision/cls/imagenet1k/torchvision/resnet18_opset9.onnx')
    }),
    # torchvision: classification resnet50_224x224 expected_metric: 76.15% top-1 accuracy
    utils.dict_update(common_cfg, {
        'preprocess':config.get_preproc_onnx(),
        'session':sessions.TVMDLRSession(**common_session_cfg, **config.session_tvm_dlr_cfg,
            model_path=f'{config.modelzoo_path}/vision/cls/imagenet1k/torchvision/resnet50_opset9.onnx')
    }),
    # # torchvision: classification vgg16_224x224 expected_metric: 71.59% top-1 accuracy - too slow inference
    # utils.dict_update(common_cfg, {
    #     'preprocess':config.get_preproc_onnx(),
    #     'session':sessions.TVMDLRSession(**common_session_cfg, **config.session_tvm_dlr_cfg,
    #         model_path=f'{config.modelzoo_path}/vision/cls/imagenet1k/torchvision/vgg16_opset9.onnx')
    # }),
    # github onnx model: classification resnet18_v2 expected_metric: 69.70% top-1 accuracy
    utils.dict_update(common_cfg, {
        'preprocess':config.get_preproc_onnx(),
        'session':sessions.TVMDLRSession(**common_session_cfg, **config.session_tvm_dlr_cfg,
            model_path=f'{config.modelzoo_path}/vision/cls/imagenet1k/onnx-models/resnet18-v2-7.onnx'),
    }),
    #################################################################
    #       TFLITE MODELS
    ##################tensorflow models##############################
    ...
    utils.dict_update(common_cfg, {
        'preprocess':config.get_preproc_tflite(),
        'session':sessions.TFLiteRTSession(**common_session_cfg, **config.session_tflite_rt_cfg,
            model_path=f'{config.modelzoo_path}/vision/cls/imagenet1k/tf1-models/mobilenet_v1_1.0_224_quant.tflite'),
        'metric':dict(label_offset_pred=-1)
    }),
    ...
    utils.dict_update(common_cfg, {
        'preprocess':config.get_preproc_tflite(),
        'session':sessions.TFLiteRTSession(**common_session_cfg, **config.session_tflite_rt_cfg,
            model_path=f'{config.modelzoo_path}/vision/cls/imagenet1k/tf1-models/mobilenet_v2_1.0_224.tflite'),
        'metric':dict(label_offset_pred=-1)
    }),
    ...
    utils.dict_update(common_cfg, {
        'preprocess':config.get_preproc_tflite(),
        'session':sessions.TFLiteRTSession(**common_session_cfg, **config.session_tflite_rt_cfg,
            model_path=f'{config.modelzoo_path}/vision/cls/imagenet1k/tf1-models/mobilenet_v2_1.0_224_quant.tflite'),
        'metric':dict(label_offset_pred=-1)
    }),
    ...
    utils.dict_update(common_cfg, {
        'preprocess':config.get_preproc_tflite(),
        'session':sessions.TFLiteRTSession(**common_session_cfg, **config.session_tflite_rt_cfg,
            model_path=f'{config.modelzoo_path}/vision/cls/imagenet1k/tf1-models/mobilenet_v2_float_1.4_224.tflite'),
        'metric':dict(label_offset_pred=-1)
    }),
    ...
    utils.dict_update(common_cfg, {
        'preprocess':config.get_preproc_tflite(),
        'session':sessions.TFLiteRTSession(**common_session_cfg, **config.session_tflite_rt_cfg,
            model_path=f'{config.modelzoo_path}/vision/cls/imagenet1k/tf-tpu/efficientnet-lite0-fp32.tflite')
    }),
    ...
    utils.dict_update(common_cfg, {
        ...
        'session':sessions.TFLiteRTSession(**common_session_cfg, **config.session_tflite_rt_cfg,
            model_path=f'{config.modelzoo_path}/vision/cls/imagenet1k/tf-tpu/efficientnet-lite1-fp32.tflite')
    }),
    ...
    utils.dict_update(common_cfg, {
        ...
        'session':sessions.TFLiteRTSession(**common_session_cfg, **config.session_tflite_rt_cfg,
            model_path=f'{config.modelzoo_path}/vision/cls/imagenet1k/tf-tpu/efficientnet-lite2-fp32.tflite')
    }),
    ...
    #     'session':sessions.TFLiteRTSession(**common_session_cfg, **config.session_tflite_rt_cfg,
    #         model_path=f'{config.modelzoo_path}/vision/cls/imagenet1k/tf-tpu/efficientnet-lite4-fp32.tflite')
    # }),
    # tensorflow/tpu: classification efficientnet-edgetpu-S expected_metric: 77.23% top-1 accuracy
    utils.dict_update(common_cfg, {
        'preprocess':config.get_preproc_tflite(),
        'session':sessions.TFLiteRTSession(**common_session_cfg, **config.session_tflite_rt_cfg,
            model_path=f'{config.modelzoo_path}/vision/cls/imagenet1k/tf-tpu/efficientnet-edgetpu-S_float.tflite'),
        'metric':dict(label_offset_pred=-1)
    }),
    ...
    utils.dict_update(common_cfg, {
        'preprocess':config.get_preproc_tflite(274, 240),
        'session':sessions.TFLiteRTSession(**common_session_cfg, **config.session_tflite_rt_cfg,
            model_path=f'{config.modelzoo_path}/vision/cls/imagenet1k/tf-tpu/efficientnet-edgetpu-M_float.tflite'),
        'metric':dict(label_offset_pred=-1)
    }),
    ...
    #     'preprocess':config.get_preproc_tflite(343, 300),
    #     'session':sessions.TFLiteRTSession(**common_session_cfg, **config.session_tflite_rt_cfg,
    #         model_path=f'{config.modelzoo_path}/vision/cls/imagenet1k/tf-tpu/efficientnet-edgetpu-L_float.tflite'),
    #     'metric':dict(label_offset_pred=-1)
    # }),
    ...
    #     'preprocess':config.get_preproc_tflite(),
    #     'session':sessions.TFLiteRTSession(**common_session_cfg, **config.session_tflite_rt_cfg,
    #         model_path=f'{config.modelzoo_path}/vision/cls/imagenet1k/tf1-models/squeezenet.tflite'),
    #     'metric':dict(label_offset_pred=-1)
    # }),
    ...
    #     'preprocess':config.get_preproc_tflite(),
    #     'session':sessions.TFLiteRTSession(**common_session_cfg, **config.session_tflite_rt_cfg,
    #         model_path=f'{config.modelzoo_path}/vision/cls/imagenet1k/tf1-models/densenet.tflite'),
    #     'metric':dict(label_offset_pred=-1)
    # }),
    ...
    utils.dict_update(common_cfg, {
        'preprocess':config.get_preproc_tflite(),
        'session':sessions.TFLiteRTSession(**common_session_cfg, **config.session_tflite_rt_cfg,
            model_path=f'{config.modelzoo_path}/vision/cls/imagenet1k/tf1-models/inception_v1_224_quant.tflite'),
        'metric':dict(label_offset_pred=-1)
    }),
    ...
    #     'session':sessions.TFLiteRTSession(**common_session_cfg, **config.session_tflite_rt_cfg,
    #         model_path=f'{config.modelzoo_path}/vision/cls/imagenet1k/tf1-models/inception_v3.tflite'),
    #     'metric':dict(label_offset_pred=-1)
    # }),
    ...
    utils.dict_update(common_cfg, {
        'preprocess':config.get_preproc_tflite(),
        'session':sessions.TFLiteRTSession(**common_session_cfg, **config.session_tflite_rt_cfg,
            model_path=f'{config.modelzoo_path}/vision/cls/imagenet1k/tf1-models/mnasnet_1.0_224.tflite'),
        'metric':dict(label_offset_pred=-1)
    }),
    ...
    utils.dict_update(common_cfg, {
        'preprocess':config.get_preproc_tflite(),
        'session':sessions.TFLiteRTSession(**common_session_cfg, **config.session_tflite_rt_cfg,
            model_path=f'{config.modelzoo_path}/vision/cls/imagenet1k/tf1-models/nasnet_mobile.tflite'),
        'metric':dict(label_offset_pred=-1)
    }),
    ...
    #     'session':sessions.TFLiteRTSession(**common_session_cfg, **config.session_tflite_rt_cfg,
    #         model_path=f'{config.modelzoo_path}/vision/cls/imagenet1k/tf2-models/resnet50.tflite')
    # }),
    # mlperf model: classification resnet50_v2 expected_metric: 76.0% top-1 accuracy
    utils.dict_update(common_cfg, {
        'preprocess':config.get_preproc_tflite(),
        'session':sessions.TFLiteRTSession(**common_session_cfg, **config.session_tflite_rt_cfg,
            model_path=f'{config.modelzoo_path}/vision/cls/imagenet1k/tf2-models/resnet50v2.tflite'),
        'metric':dict(label_offset_pred=-1)
    }),
    ...
    #     'preprocess':config.get_preproc_tflite(342, 299),
    #     'session':sessions.TFLiteRTSession(**common_session_cfg, **config.session_tflite_rt_cfg,
    #         model_path=f'{config.modelzoo_path}/vision/cls/imagenet1k/tf2-models/xception.tflite')
    # }),
    ...
    utils.dict_update(common_cfg, {
        ...
        'session':sessions.TFLiteRTSession(**common_session_cfg, **config.session_tflite_rt_cfg,
            model_path=f'{config.modelzoo_path}/vision/cls/imagenet1k/mlperf/resnet50-v1.5.tflite'),
        'metric':dict(label_offset_pred=-1)
    }),
]
