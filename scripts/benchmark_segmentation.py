...
pipeline_configs = [
    ...
    utils.dict_update(common_cfg, {
        ...
        'session':sessions.TVMDLRSession(**config.session_tvm_dlr_cfg, work_dir=work_dir,
            model_path=f'{config.modelzoo_path}/vision/segmentation/cityscapes/pytorch-jai-devkit/deeplabv3lite_mobilenetv2_tv_768x384_2019-06-26_08-59-32_opset9.onnx'),
