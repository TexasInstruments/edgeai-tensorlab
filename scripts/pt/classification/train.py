...
def load_data(traindir, valdir, args):
    ...
    elif args.epoch_size > 0 and args.epoch_size != 1.0:
        epoch_size_samples = int(len(dataset)*args.epoch_size) if args.epoch_size<1 else args.epoch_size
        train_sampler = torch.utils.data.sampler.RandomSampler(dataset, replacement=True, num_samples=epoch_size_samples)
