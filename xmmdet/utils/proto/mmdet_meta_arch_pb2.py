...
_TIDLMARETINANET = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='x_scale', full_name='tidl_meta_arch.TidlMaRetinaNet.x_scale', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='y_scale', full_name='tidl_meta_arch.TidlMaRetinaNet.y_scale', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='width_scale', full_name='tidl_meta_arch.TidlMaRetinaNet.width_scale', index=8,
      number=9, type=2, cpp_type=6, label=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='height_scale', full_name='tidl_meta_arch.TidlMaRetinaNet.height_scale', index=9,
      number=10, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=float(5),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='score_converter', full_name='tidl_meta_arch.TidlMaRetinaNet.score_converter', index=10,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='anchor_param', full_name='tidl_meta_arch.TidlMaRetinaNet.anchor_param', index=11,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='detection_output_param', full_name='tidl_meta_arch.TidlMaRetinaNet.detection_output_param', index=12,
