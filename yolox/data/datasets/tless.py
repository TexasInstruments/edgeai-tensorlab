...
class CADModelsTLESS():
    def __init__(self, data_dir=None):
        if data_dir is None:
            data_dir = os.path.join(get_yolox_datadir(), "tless")
...
class TLESSDataset(Dataset):
    ...
    def __init__(
        ...
        """
        T-LESS dataset initialization. Annotation data are read into memory by COCO API.
        Args:
            data_dir (str): dataset root directory
            json_file (str): T-LESS json file name
            name (str): T-LESS data name
        ...
        self.cad_models = CADModelsTLESS()
