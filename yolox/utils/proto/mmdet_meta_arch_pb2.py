...
_PRIORBOX3DODPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='anchor_length', full_name='tidl_meta_arch.PriorBox3DODParameter.anchor_length', index=0,
      number=1, type=2, cpp_type=6, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='anchor_width', full_name='tidl_meta_arch.PriorBox3DODParameter.anchor_width', index=1,
      number=2, type=2, cpp_type=6, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='anchor_height', full_name='tidl_meta_arch.PriorBox3DODParameter.anchor_height', index=2,
      number=3, type=2, cpp_type=6, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='anchor_length_offset', full_name='tidl_meta_arch.PriorBox3DODParameter.anchor_length_offset', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='rotation', full_name='tidl_meta_arch.PriorBox3DODParameter.rotation', index=4,
...
_TIDLMA3DOD = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='max_points_per_voxel', full_name='tidl_meta_arch.TidlMa3DOD.max_points_per_voxel', index=13,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='score_converter', full_name='tidl_meta_arch.TidlMa3DOD.score_converter', index=14,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='prior_box_3dod_param', full_name='tidl_meta_arch.TidlMa3DOD.prior_box_3dod_param', index=15,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='detection_output_param', full_name='tidl_meta_arch.TidlMa3DOD.detection_output_param', index=16,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='data_layout', full_name='tidl_meta_arch.TidlMa3DOD.data_layout', index=17,
